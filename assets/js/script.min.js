...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let headerSubList = document.querySelectorAll(".header__item");
    let subListActive = document.querySelectorAll(".header-sub__list");
    ...
    let openSlide = document.querySelectorAll(".cursor-slide");
    openSlide.forEach((item,i)=>{
        item.addEventListener("click", ()=>{

            item.classList.toggle("cursor-slide--active");

            // if( item.classList.contains("cursor-slide--active")){
